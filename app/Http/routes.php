...
*/
	...
	*/
	...
	Route::group(['middleware' => ['accounts_auth']], function () {
		...
		#Accounts Student Payment Summery
		Route::get('/accounts/student/payment/summery',array('as'=>'Accounts Student Payment Summery','uses'=>'AccountsController@StudentPaymentSummery'));

		#Accounts Student Payment Summery Excel
		Route::get('/accounts/student/payment/summery/excel/program-{program}/batch-{batch}',array('as'=>'Accounts Student Payment Summery Excel','uses'=>'AccountsController@StudentPaymentSummeryExcel'));
		...
		#Accounts Summery
		Route::get('/accounts/account-summery',array('as'=>'Accounts Summery','uses'=>'AccountsController@AccountSummeryPage'));

		#Accounts Summery Excel Download
		Route::get('/accounts/summery/download/program-{program}/from-{search_from}/to-{search_to}',array('as'=>"Accounts Summery Excel Download",'uses'=>'AccountsController@AccountSummeryExcelDownload'));
	...
	*/
	...
	Route::group(['middleware' => ['register_auth']], function () {
		...
		#Registrar All Summery
		Route::get('/register/all-summery',array('as'=>"Registrar All Summery",'uses'=>'RegisterController@RegisterAllSummery'));

		#Registrar Account Summery
		Route::get('/register/account-summery',array('as'=>"Registrar Account Summery",'uses'=>'RegisterController@RegisterAccountSummeryPage'));
		...
		#Registrar Student Booking Supplimentry Course
		Route::get('/register/student/booking/supplimentry/course',array('as'=>'Registrar Booking Supplimentry Course','uses'=>'RegisterController@RegisterStudentBookingSupplimentryCourse'));

		#Registrar Student Booking Supplimentry Course Confirm
		Route::post('/register/student/booking/supplimentry/course/confirm',array('as'=>'Registrar Booking Supplimentry Course Confirm','uses'=>'RegisterController@RegisterSupplimentryCourseBookingConfirm'));

		#Registrar Student Booking Supplimentry Course List
		Route::get('/register/student/booking/supplimentry/course/list',array('as'=>'Supplimentry Course List','uses'=>'RegisterController@RegisterStudentBookingSupplimentryCourseList'));

		#Registrar Supplimentry Course Delete
		Route::get('/register/supplimentry/delete/{supplimentry_tran_code}',array('as'=>'Registrar Supplimentry Course Delete','uses'=>'RegisterController@RegisterSupplimentryCourseBookingDelete'));

		#Registrar Student Supplimentry Course
		Route::get('/register/student/supplimentry/course',array('as'=>'Registrar Supplimentry Course','uses'=>'RegisterController@RegisterStudentSupplimentryCourse'));

		#Registrar Supplimentry Result Update
		Route::post('/register/supplimentry-result-update/{student_serial_no}/{course_code}/{program}/{semester}/{year}',array('as'=>'Registrar Supplimentry Result Update','uses'=>'RegisterController@SupplimentryCourseResultUpdate'));
