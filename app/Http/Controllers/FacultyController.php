    ...
    *********************************************/
    ...
    public function ProgramHeadResultPublish(){
      ...
      if(!empty($univ_academic_calender) && !empty($faculty_basic)){
        ...
        // ->select('tabulation_course_id','tabulation_program','tabulation_semester','tabulation_year','tabulation_status', \DB::raw('count(*) as total'))
        // ->groupBy('tabulation_course_id','tabulation_program','tabulation_semester','tabulation_year','tabulation_status')
