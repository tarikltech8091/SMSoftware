...
class StudentController extends Controller{
    ...
    public function StudentEditProfile(){
        ...
        $data['student_academic']=\DB::table('student_academic_qualification')->get();
    ...
    *********************************************/
    ...
    public function AjaxStudentCoursePlanDetails($program, $course_category){
        ...
        $course_category_info=\DB::table('course_category')->where('course_category_slug',$course_category)->first();
        $course_category_name=$course_category_info->course_category_name;
