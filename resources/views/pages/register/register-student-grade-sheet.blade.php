	...
	<div class="col-md-12 course">
		<div class="panel panel-info">
			<div class="panel-body">
				<form method="get" action="{{url('/register/student/grade-sheet')}}">
					...
					<div class="form-group col-md-2" style="margin-top:27px;">
						<button type="submit" class="btn btn-primary" data-toggle="tooltip" title="Search Academic Result">Serach</button>
					</div>
				</form>
			</div>
		</div>
			...
			<div class="panel-body"><!--info body-->
				...
				<div class="grade_sheet">
					...
					<table id="" class="table table-striped ">
						<thead>
							<tr>
								<th class="tbl_caption" colspan="6">Final Result : {{ isset($semester_info->semester_title) ? $semester_info->semester_title : 'All'}} {{isset($year) && $year!=0 ? $year : 'Info'}}</th>
							</tr>
							<tr>
								<th>Course Code</th>
								<th>Course Title</th>
						...
						<tbody>
							...
							@else
								<tr><th colspan="6" class="text-center">No Data Available !!</th></tr>
							@endif
