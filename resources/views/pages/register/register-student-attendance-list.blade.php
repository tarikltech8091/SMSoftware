...
<div class="row page_row">
	<div class="col-md-12">
		<div class="panel panel-body padding_0 ">
			...
			<form action="{{url('/register/student/attendance/list')}}" method="get" enctype="multipart/form-data">
				<?php 
		...
		<div class="col-md-12">
			@if(isset($_GET['program']) && isset($_GET['semester']) && isset($_GET['academic_year']) && isset($_GET['course']) && isset($_GET['attendance_date_value']))
				...
				<div class="panel panel-body padding_0">
					...
					<form action="{{url('/register/student/attendance/list/submit')}}" method="post" enctype="multipart/form-data">
