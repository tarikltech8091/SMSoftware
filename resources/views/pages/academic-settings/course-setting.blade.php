	...
	<div class="col-md-12 semester profile_tab">
		...
		<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
			<ul id="myTab" class="nav nav-tabs" role="tablist">
				...
				<li role="presentation" class="{{$tab=='course_catalogue' ? '' :''}}"><a href="#course_catalogue" role="tab" id="course_catalogue-tab" data-toggle="tab" aria-controls="course_catalogue"><i class="fa fa-newspaper-o"></i>Course Catalouge</a></li>
				...
				<!-- <li role="presentation" class="{{$tab=='course_categoty' ? '' :''}}"><a href="#course_plan" role="tab" id="course_plan-tab" data-toggle="tab" aria-controls="course_plan"><i class="fa fa-map"></i>Course Plan</a></li>	 -->
...
<!-- 								<div class="row">
						...
						<div class="col-md-8"><!---Course table -->
							<table class="table table-bordered  table-hover">
								<thead>
									<tr>
										<th>Course Code</th>
