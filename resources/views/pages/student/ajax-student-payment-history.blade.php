<div class="col-md-12">
	<table class="table table-striped table-bordered table-hover table-condensed" style="background-color:#EDEDED" >
		<thead>
			<tr>
			<th colspan="9"><center>Payment Ledger: {{isset($semester_title) ? $semester_title : ''}} {{isset($year) ? $year : ''}}</center></th>
			</tr>
			<tr>
				<th>Tran Date</th>
				<th>Trimester</th>
		...
		<tbody>
			...
			<tr>
				<td>
					{{date("Y-m-d",strtotime($student_payment_transaction->created_at))}}
				</td>
