		...
		<div data-example-id="togglable-tabs" role="tabpanel" class="bs-example bs-example-tabs">
			...
			<div class="tab-content" id="myTabContent">
				...
				<div aria-labelledby="qualification-tab" id="qualification" class="tab-pane fade" role="tabpanel">
					...
					@if($student_academic->student_tran_code==$edit->student_tran_code && ($student_academic->exam_type=='SSC' || $student_academic->exam_type=='olevel'))
					<div class="row page_row">
						<div class="form-group col-md-2">
							<label>Result Type</label>
							<input type="text" class="form-control" value="{{$student_academic->exam_type}}" disabled />
						</div>

						<div class="form-group col-md-2">
							<label>Institution</label>
							<input type="text" class="form-control" value="{{$student_academic->institute_name}}" disabled />
						</div>
					...
					@if($student_academic->student_tran_code==$edit->student_tran_code && ($student_academic->exam_type=='HSC' || $student_academic->exam_type=='Alevel'))
					<div class="row page_row">
						<div class="form-group col-md-2">
							<label>Result Type</label>
							<input type="text" class="form-control" value="{{$student_academic->exam_type}}" disabled />
