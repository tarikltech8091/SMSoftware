...
<div class="left-side-inner">
	...
	<ul class="nav nav-pills nav-stacked custom-nav">
		...
		<li class="cursor"><a href="{{url('/accounts/account-summery')}}"><i class="fa fa-th-large" aria-hidden="true"></i><span>Accounts Summery</span></a></li>
		...
		<li class="cursor"><a href="{{url('/accounts/student/payment/summery')}}"><i class="fa fa-credit-card" aria-hidden="true"></i><span>Student Payment Summery</span></a></li>
...
<div class="left-side-inner">
	...
	<ul class="nav nav-pills nav-stacked custom-nav">
		...
		<li class="menu-list cursor"><a><i class="fa fa-user-plus"></i> <span>Registration</span></a>
			<ul class="sub-menu-list">
				...
				@if((\Auth::user()->user_type) == 'register' && (\Auth::user()->user_role) == 'head') 
					...
					<li><a href="{{url('/register/account-summery')}}">Account Summery</a></li>
					<li><a href="{{url('/register/student/grade-sheet')}}">Student Grade Sheet</a></li>

				@endif

				<li><a href="{{url('/register/attendance/percent')}}">Register Student Attendance List</a></li>
				...
				<li><a href="{{url('/register/all-summery')}}">Register All Summery</a></li>
		...
		<li class="menu-list cursor"><a><i class="fa fa-book" aria-hidden="true"></i><span>Supplimentry</span></a>
			<ul class="sub-menu-list">
				<li><a href="{{url('/register/student/booking/supplimentry/course')}}">Registrar Booking Supplimentry Course</a></li>
				<li><a href="{{url('/register/student/booking/supplimentry/course/list')}}">Supplimentry Course List</a></li>
				<li><a href="{{url('/register/student/supplimentry/course')}}">Supplimentry Course</a></li>
