...
<p style="margin-top: 0; font-weight: 400; font-size: 14px;	line-height: 22px; color: #7c7e7f; font-family: Georgia,serif; margin-bottom: 22px;"><b>{{$applicant_info->first_name}} {{$applicant_info->middle_name}} {{$applicant_info->last_name}},</b> Your Admission Application has been received  succesfully.</p>
...
<p style="margin-top: 0; font-weight: 400; font-size: 14px;	line-height: 22px; color: #7c7e7f; font-family: Georgia,serif; margin-bottom: 22px; font-weight:bold">Your application will confirmed by NDUB after receiving application payment.</p>

<p style="margin-top: 0; font-weight: 400; font-size: 14px;	line-height: 22px; color: #7c7e7f; font-family: Georgia,serif; margin-bottom: 22px;">For details: <a href="http://student.ndub.com.bd" target="_blank">Click the link...</a></p>
